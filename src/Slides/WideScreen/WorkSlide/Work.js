...
class Work extends Component {
  ...
  componentDidMount() {
    ...
    this.setState(
      {
        vh: Math.round(
          window.document.documentElement.clientHeight * this.pageSplitTimes,//this is what determines the height
        ),
      },
  ...
  handleScroll(event) {
    ...
    //console.log(vh);
    //console.log(scrollDistance,body.scrollTop, documentElement.scrollTop, 20000);
