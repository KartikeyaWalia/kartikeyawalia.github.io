...
margin-left:50%;
width:50%;
height:1460vh; /*this controls the total height, uff*/
display: flex;
...
class ImageContent extends Component {
  ...
  handleScroll() {
    ...
    const maxlimit = (documentElement.clientHeight * 2040) / documentElement.scrollHeight;//this decides if the scroll and other effects will work, how much down?
